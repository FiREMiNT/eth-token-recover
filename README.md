...
[![CI](https://github.com/firemint/eth-token-recover/actions/workflows/ci.yml/badge.svg)](https://github.com/firemint/eth-token-recover/actions/workflows/ci.yml)
[![Coverage Status](https://coveralls.io/repos/github/firemint/eth-token-recover/badge.svg?branch=master)](https://coveralls.io/github/firemint/eth-token-recover?branch=master)
[![MIT licensed](https://img.shields.io/github/license/firemint/eth-token-recover.svg)](https://github.com/firemint/eth-token-recover/blob/master/LICENSE)
...
* [TokenRecover.sol](https://github.com/firemint/eth-token-recover/blob/master/contracts/TokenRecover.sol)
...
Code released under the [MIT License](https://github.com/firemint/eth-token-recover/blob/master/LICENSE).
